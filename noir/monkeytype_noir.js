...
(function() {
	...
	<video autoplay muted loop id="myVideo">
	  <source src="https://byun-sungwoo.github.io/videos/noir.webm" type="video/webm">
	</video>
	...
	:root {
		/*Theme Colors*/
		--leaderboard-bg: rgba(53,52,53, .9);
		--frost-bg: rgba(255,255,255,.1);
		--text-primary: rgb(255, 255, 255);
		--text-secondary: #909090;
		--text-error: #943D38;
		--text-caret: #353435;
		--error-underline-color: #943D38;
